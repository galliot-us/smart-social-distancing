...
def im_to_tensor(img):
    """Transform ndarray image to TF tensor.
    Parameters
    ----------
    img: numpy.ndarray
    ...
    img = to_tensor(img)
    #if img.max() > 1: # Do not need it bcs before it all images are normalized
    #    img /= 255
    return img


def to_tensor(ndarray):
    # numpy.ndarray => tf.Tensor
    return tf.convert_to_tensor(ndarray, dtype=float)
