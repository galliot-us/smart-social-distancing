...
class CifCafDecoder():
    def __init__(self):
        self.cif_metas = pickle.load(open( "/repo/libs/detectors/x86/openpifpaf_tensorrt/cif_metas.pkl", "rb" ))
        self.caf_metas = pickle.load(open( "/repo/libs/detectors/x86/openpifpaf_tensorrt/caf_metas.pkl", "rb" ))
