...
python3 $relative_path/exporters/trt_exporter.py --pb_file $pb_file --out_dir $relative_path/data/jetson --neuralet_adaptive_model $adaptive_model --num_classes $num_classes
# mv $relative_path/data/jetson/frozen_inference_graph.bin $relative_path/detectors/data/
